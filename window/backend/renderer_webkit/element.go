...
import (
	...
	"github.com/lmorg/ttyphoon/window/elements/element_content_editable"
...
func (wr *webkitRender) NewElement(tile types.Tile, id types.ElementID, v ...any) types.Element {
	switch id {
	...
	case types.ELEMENT_ID_CONTENT_EDITABLE:
		return element_content_editable.New(wr, tile, v[0].(map[string]bool))
